            ...
            children: [
              Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: const [
                      Text('Avui, dissabte, 11 d\'abril', style: TextStyle(color: Colors.grey, fontSize: 13)),
                      SizedBox(height: 4),
                      Text.rich(TextSpan(children: [
                        TextSpan(text: 'Benvingut de nou, ', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF1A1D2E))),
                        TextSpan(text: 'Usuari ', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF4B5EFC))),
              ...
              if (_showAlert) ...[
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.warning_amber_rounded, color: Color(0xFFFF8F00), size: 28),
                      const SizedBox(width: 12),
                      const Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Porta 1h 23m assegut!', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF8B5E00), fontSize: 14)),
                            SizedBox(height: 2),
                            Text('Et recomanem fer una pausa i estirar-te.', style: TextStyle(color: Color(0xFFAD7E00), fontSize: 13)),
                          ],
                        ),
                      ),
                      GestureDetector(
                        onTap: () => setState(() => _showAlert = false),
                        child: const Icon(Icons.close, color: Color(0xFFAD7E00), size: 20),
                      ),
                    ],
                  ),
                ),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text('Postura actual', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                          decoration: BoxDecoration(color: const Color(0xFFFFF3CD), borderRadius: BorderRadius.circular(20)),
                          child: const Text('2/3 sensors correctes', style: TextStyle(color: Color(0xFF8B5E00), fontWeight: FontWeight.bold, fontSize: 12)),
                        ),
                      ],
                    ),
                    const SizedBox(height: 16),
                    Row(
                      children: [
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(children: const [
                                ...
                                SizedBox(width: 4),
                                Text('Correcte', style: TextStyle(fontSize: 11, color: Colors.grey)),
                                SizedBox(width: 12),
                                Icon(Icons.circle, color: Colors.red, size: 10),
                                SizedBox(width: 4),
                                Text('Alerta', style: TextStyle(fontSize: 11, color: Colors.grey)),
                              ]),
                            ],
                          ),
                        ),
                        ...
                        Expanded(
                          child: Column(
                            children: [
                              const Text('Avui', style: TextStyle(color: Colors.grey, fontSize: 13)),
                              const SizedBox(height: 8),
                              SizedBox(
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    CircularProgressIndicator(value: 0.78, strokeWidth: 10, backgroundColor: Colors.grey.shade200, valueColor: const AlwaysStoppedAnimation<Color>(Colors.green)),
                                    const Column(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        Text('78%', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.green)),
                                        Text('bona postura', style: TextStyle(fontSize: 10, color: Colors.grey)),
                                      ],
                                    ),
                                  ],
                                ),
                              ...
                              const SizedBox(height: 12),
                              const Text('Temps assegut', style: TextStyle(color: Colors.grey, fontSize: 13)),
                              const Text('1h 23m', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                            ],
                          ),
                        ),
                      ],
              ...
              Row(
                children: [
                  _statCard(Icons.access_time, '1h 23m', 'Temps actiu', const Color(0xFFE8F0FE), const Color(0xFF4B5EFC)),
                  const SizedBox(width: 12),
                  _statCard(Icons.trending_up, '12', 'Correccions', const Color(0xFFFFF0E8), const Color(0xFFFF8C42)),
                  const SizedBox(width: 12),
                  _statCard(Icons.check_circle_outline, '2 / 4', 'Pauses', const Color(0xFFE8F5E9), const Color(0xFF43A047)),
                ],
              ),
              const SizedBox(height: 20),
            ],
    ...
    return Row(
      children: [
        Container(
          ...
          child: Icon(ok ? Icons.check : Icons.warning_amber_rounded, size: 14, color: ok ? Colors.green : Colors.red),
        ),
        ...
        Column(
          ...
          children: [
            ...
            Text(value, style: TextStyle(fontSize: 12, color: ok ? Colors.green : Colors.red)),
          ],
        ),
      ],
    );
...
class _EstadistiquesPageState extends State<EstadistiquesPage> {
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Anàlisi de dades', style: TextStyle(color: Colors.grey, fontSize: 13)),
              const Text('Estadístiques', style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Color(0xFF1A1D2E))),
              const SizedBox(height: 20),
              Container(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: selected ? [BoxShadow(color: Colors.black.withOpacity(0.08), blurRadius: 4)] : [],
                          ),
                          child: Text(e.value, textAlign: TextAlign.center, style: TextStyle(fontWeight: selected ? FontWeight.bold : FontWeight.normal, color: selected ? const Color(0xFF4B5EFC) : Colors.grey)),
                        ),
                      ),
                    );
                  }).toList(),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: const [
                        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('% Bona postura', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                          Text('Aquesta setmana', style: TextStyle(color: Colors.grey, fontSize: 13)),
                        ]),
                        Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                          Text('79%', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Color(0xFFFF8C42))),
                          Text('Mitjana', style: TextStyle(color: Colors.grey, fontSize: 12)),
                        ]),
                      ],
                    ),
                    const SizedBox(height: 12),
                    Row(children: const [
                      Icon(Icons.circle, color: Colors.green, size: 10),
                      SizedBox(width: 4),
                      Text('≥80% Excel·lent', style: TextStyle(fontSize: 11, color: Colors.grey)),
                      SizedBox(width: 12),
                      Icon(Icons.circle, color: Color(0xFFFF8C42), size: 10),
                      SizedBox(width: 4),
                      Text('≥60% Acceptable', style: TextStyle(fontSize: 11, color: Colors.grey)),
                      SizedBox(width: 12),
                      Icon(Icons.circle, color: Colors.red, size: 10),
                      SizedBox(width: 4),
                      Text('<60% Millorable', style: TextStyle(fontSize: 11, color: Colors.grey)),
                    ]),
                    const SizedBox(height: 16),
                    Row(
                        ...
                        return Column(
                          children: [
                            ...
                            Container(
                              width: 38, height: 38,
                              decoration: BoxDecoration(
                                color: d['value'] != null ? (d['color'] as Color).withOpacity(0.15) : Colors.grey.shade100,
                                borderRadius: BorderRadius.circular(10),
                                border: Border.all(color: d['value'] != null ? d['color'] as Color : Colors.grey.shade300, width: 1.5),
                              ),
                              child: Center(
                                child: Text(
                                  d['value'] != null ? '${d['value']}%' : '–',
                                  style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: d['value'] != null ? d['color'] as Color : Colors.grey),
                                ),
                              ),
                            ),
                          ],
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(children: [
                            Container(width: 32, height: 32, decoration: BoxDecoration(color: const Color(0xFFE8F0FE), shape: BoxShape.circle), child: const Icon(Icons.sync, color: Color(0xFF4B5EFC), size: 16)),
                            const SizedBox(width: 8),
                            const Text('Última sync', style: TextStyle(fontWeight: FontWeight.w600)),
                          ]),
                          const SizedBox(height: 10),
                          const Text('17:55', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                          const Text("11 d'abr.", style: TextStyle(color: Colors.grey, fontSize: 13)),
                          const SizedBox(height: 6),
                          Row(children: const [
                            Icon(Icons.circle, color: Colors.green, size: 10),
                            SizedBox(width: 4),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(children: [
                            Container(width: 32, height: 32, decoration: BoxDecoration(color: const Color(0xFFFFF0E8), shape: BoxShape.circle), child: const Icon(Icons.replay, color: Color(0xFFFF8C42), size: 16)),
                            const SizedBox(width: 8),
                            const Text('Correccions', style: TextStyle(fontWeight: FontWeight.w600)),
                          ]),
                          const SizedBox(height: 10),
                          const Text('58', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                          const Text('aquesta setmana', style: TextStyle(color: Colors.grey, fontSize: 13)),
                          const SizedBox(height: 6),
                          const Text('→ Acceptable', style: TextStyle(color: Color(0xFFFF8C42), fontWeight: FontWeight.w600, fontSize: 13)),
                        ],
                      ),
                    ),
                  ),
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Correccions per dia', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    const Text('Menys correccions = millor postura mantinguda', style: TextStyle(color: Colors.grey, fontSize: 12)),
                    const SizedBox(height: 16),
                    _SimpleBarChart(),
                  ],
                ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(children: const [
                      Icon(Icons.trending_up, color: Color(0xFF4B5EFC), size: 18),
                      SizedBox(width: 8),
                      Text("Tendència d'asimetries", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    ]),
                    const Text('Desviació postural lateral (en graus)', style: TextStyle(color: Colors.grey, fontSize: 12)),
                    const SizedBox(height: 12),
                    Row(children: const [
                    ...
                    const SizedBox(height: 12),
                    const SizedBox(height: 120, child: _SimpleLineChart()),
                    const Divider(),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: const [
                        Text('Asimetria mitjana:', style: TextStyle(color: Colors.grey)),
                        Row(children: [
                          Text('1.5° E', style: TextStyle(color: Colors.purple, fontWeight: FontWeight.bold)),
                          SizedBox(width: 12),
                          Text('-1.2° D', style: TextStyle(color: Color(0xFF4B5EFC), fontWeight: FontWeight.bold)),
                        ]),
                      ],
                    ),
                  ],
              ...
              Container(
                padding: const EdgeInsets.all(20),
                decoration: BoxDecoration(gradient: const LinearGradient(colors: [Color(0xFF2ECC71), Color(0xFF27AE60)], begin: Alignment.topLeft, end: Alignment.bottomRight), borderRadius: BorderRadius.circular(20)),
                child: Row(
                  children: [
                    Container(width: 44, height: 44, decoration: BoxDecoration(color: Colors.white.withOpacity(0.3), borderRadius: BorderRadius.circular(12))),
                    const SizedBox(width: 16),
                    const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('Descarregar informe', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
                      Text('Resum complet del mes en PDF', style: TextStyle(color: Colors.white70, fontSize: 13)),
                    ])),
                    ...
                    Row(
                      ...
                      children: [
                        const Row(children: [
                          ...
                          SizedBox(width: 8),
                          Text('Competició', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                        ]),
                        ElevatedButton.icon(
                          onPressed: () {},
                          icon: const Icon(Icons.person_add_outlined, size: 16),
                          label: const Text('Convidar'),
                          style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF4B5EFC), foregroundColor: Colors.white, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)), padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 8)),
                        ),
                      ],
                    ),
                    const SizedBox(height: 16),
                    _competitorRow('1', 'MG', 'Maria G.', '🔥 12 dies', 91, Colors.purple, Colors.green, true),
                    _competitorRow('2', 'TU', 'Tu', '🔥 7 dies', 78, const Color(0xFF4B5EFC), const Color(0xFFFF8C42), false, isMe: true),
                    _competitorRow('3', 'PR', 'Pau R.', '🔥 5 dies', 74, Colors.teal, const Color(0xFFFF8C42), false),
                    _competitorRow('4', 'LM', 'Laia M.', '🔥 3 dies', 65, Colors.orange, const Color(0xFFFF8C42), false),
                    const SizedBox(height: 12),
                    Container(
                      padding: const EdgeInsets.all(16),
                      decoration: BoxDecoration(color: const Color(0xFF4B5EFC).withOpacity(0.1), borderRadius: BorderRadius.circular(14)),
                      child: Row(
                        children: const [
                          Text('👑', style: TextStyle(fontSize: 20)),
                          SizedBox(width: 12),
                          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text('Repte setmanal actiu', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF4B5EFC))),
                            Text('Qui aconsegueix el 90% de bona postura primer?', style: TextStyle(color: Colors.grey, fontSize: 12)),
                          ])),
  ...
  Widget _competitorRow(String pos, String initials, String name, String streak, int percent, Color avatarColor, Color percentColor, bool isFirst, {bool isMe = false}) {
    return Container(
      ...
      child: Row(
        children: [
          Text(isFirst ? '🥇' : pos == '2' ? '🥈' : pos == '3' ? '🥉' : pos, style: const TextStyle(fontSize: 16)),
            ...
            child: Column(
              ...
              children: [
                Row(children: [
                  ...
                  if (isMe) ...[const SizedBox(width: 6), Container(padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2), decoration: BoxDecoration(color: const Color(0xFF4B5EFC), borderRadius: BorderRadius.circular(6)), child: const Text('Tu', style: TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold)))],
                ]),
          ...
          Column(
            ...
            children: [
              Text('$percent%', style: TextStyle(fontWeight: FontWeight.bold, color: percentColor)),
              const SizedBox(height: 4),
              SizedBox(
                width: 60,
                child: LinearProgressIndicator(value: percent / 100, backgroundColor: Colors.grey.shade200, valueColor: AlwaysStoppedAnimation<Color>(percentColor), minHeight: 4, borderRadius: BorderRadius.circular(4)),
              ),
            ],
          ),
        ],
      ...
      child: Row(
        ...
        children: data.map((d) {
          ...
          return Column(
            ...
            children: [
              Container(width: 28, height: h.clamp(4.0, 90.0), decoration: BoxDecoration(color: d['color'] as Color, borderRadius: BorderRadius.circular(4))),
              const SizedBox(height: 4),
              Text(d['day'], style: const TextStyle(fontSize: 11, color: Colors.grey)),
            ],
          );
        }).toList(),
      ),
...
class _LineChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paint = Paint()..color = const Color(0xFF4B5EFC)..strokeWidth = 2..style = PaintingStyle.stroke;
    final dotPaint = Paint()..color = const Color(0xFF4B5EFC)..style = PaintingStyle.fill;
    final path = Path();
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Calibració', style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Color(0xFF1A1D2E))),
              const SizedBox(height: 20),
              Container(
                padding: const EdgeInsets.all(20),
                decoration: BoxDecoration(gradient: const LinearGradient(colors: [Color(0xFF4B5EFC), Color(0xFF7B8FFF)], begin: Alignment.topLeft, end: Alignment.bottomRight), borderRadius: BorderRadius.circular(20)),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Row(children: [
                      ...
                      const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text('Toca per començar la calibració', style: TextStyle(color: Colors.white70, fontSize: 13)),
                      ]),
                    ]),
                    const SizedBox(height: 16),
                    Row(children: const [
                      ...
                      SizedBox(width: 8),
                      Text("Prepara't per seure en postura correcta", style: TextStyle(color: Colors.white, fontSize: 13)),
                    ]),
                  ],
                ),
              ),
                ...
                child: Column(
                  ...
                  children: [
                    Row(children: const [
                      ...
                      SizedBox(width: 8),
                      Text('Com calibrar els sensors', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                    ]),
                    const SizedBox(height: 8),
                    const Text('Segueix aquests passos per obtenir els millors resultats:', style: TextStyle(color: Color(0xFF4B5EFC), fontSize: 13)),
                    const SizedBox(height: 16),
                    ...[
                      ...
                      child: Row(children: [
                        Container(
                          width: 26, height: 26,
                          decoration: const BoxDecoration(color: Color(0xFF4B5EFC), shape: BoxShape.circle),
                          child: Center(child: Text('${e.key + 1}', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12))),
                        ),
                        const SizedBox(width: 12),
                        Expanded(child: Text(e.value, style: const TextStyle(color: Color(0xFF4B5EFC), fontSize: 14))),
                      ]),
                    )),
                  ],
                ),
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: const [
                    Text('Vídeo tutorial', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    SizedBox(height: 4),
                    Text("Aprèn com col·locar correctament el coixí i calibrar l'aplicació", style: TextStyle(color: Colors.grey, fontSize: 13)),
                    SizedBox(height: 16),
                    AspectRatio(
                      aspectRatio: 16 / 9,
                      child: DecoratedBox(
                        decoration: BoxDecoration(color: Color(0xFFE8F0FE), borderRadius: BorderRadius.all(Radius.circular(12))),
                        child: Icon(Icons.play_circle_outline, size: 48, color: Color(0xFF4B5EFC)),
                      ),
                    ),
                  ],
                ),
